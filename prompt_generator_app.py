...
LOGO_SVG = """
<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 249.69 100" style="width: 120px; height: auto;">
  <defs>
    <style>
      .st0 {
        fill: currentColor;
...
with st.sidebar:
    ...
    st.markdown("<h1 style='color: white; text-align: center; margin-top: 0;'>✨ Prompt Generator</h1>", unsafe_allow_html=True)
    st.markdown("---")
