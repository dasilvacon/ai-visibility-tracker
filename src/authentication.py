...
def login_page():
    ...
    <style>
        ...
        .stForm button:hover {{
            ...
            box-shadow: 0 4px 12px rgba(232, 215, 160, 0.4);
        }}
    </style>
    ...
    st.markdown("<h1 class='login-title'>Prompt Generator</h1>", unsafe_allow_html=True)
    st.markdown("<p class='login-subtitle'>Administrator Access Only</p>", unsafe_allow_html=True)
